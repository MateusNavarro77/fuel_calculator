...
void main() {
  group('FuelCalculation Unit Tests', () {
    test(
      'Calcula distância, litros e custo corretamente para viagem só de ida',
      () {
    ...
    test(
      'Retorna 0 para litros e custo se consumo for zero ou negativo (RN01)',
      () {
        const calculation = FuelCalculation(
          outboundDistanceKm: 100.0,
          isRoundTrip: false,
    ...
    test(
      'Retorna custo 0 se preço do combustível for zero ou negativo (RN02)',
      () {
        const calculation = FuelCalculation(
          outboundDistanceKm: 100.0,
          isRoundTrip: false,
